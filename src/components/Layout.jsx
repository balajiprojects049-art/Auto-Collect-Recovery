    ...
    return (
        ...
        */}
                <a
                    ...
                    className="bg-brand-yellow text-brand-dark p-4 rounded-full shadow-lg hover:bg-yellow-400 transition-transform hover:scale-110 flex items-center justify-center animate-pulse"
